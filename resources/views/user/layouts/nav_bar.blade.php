...
<li class="notify">
<a href="#">
<img src="{{ asset('template/user/img/demo/avatar/avatar2.jpg') }}" alt="Alex" />
...
<li class="msg">
<a href="#">
<img src="{{ asset('template/user/img/demo/avatar/avatar3.jpg') }}" alt="Sarah's Avatar" />
<div>
...
<li class="msg">
<a href="#">
<img src="{{ asset('template/user/img/demo/avatar/avatar4.jpg') }}" alt="Emma's Avatar" />
<div>
...
<li class="msg">
<a href="#">
<img src="{{ asset('template/user/img/demo/avatar/avatar5.jpg') }}" alt="John's Avatar" />
<div>
...
<img class="nav-user-photo" src="{{ asset('public/backend/profile_picture').'/'.Session::get('user_admin_data')[0] ['avater'] }}" />
...
<li>Welcome, <strong>
{{ Session::get('user_admin_data')[0] ['first_name'] }}
</strong></li>
