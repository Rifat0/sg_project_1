...
Software Galaxy Master Admin Portal
</small>
</a>
...
<img class="nav-user-photo" src="{{ asset('public/backend/profile_picture').'/'.Session::get('user_master_data')[0] ['avater'] }}" />
{{ Session::get('user_data')[0] ['firstName']}}
</span>
...
<li><strong>
{{ Session::get('user_master_data')[0] ['first_name'] }}
</strong></li>
